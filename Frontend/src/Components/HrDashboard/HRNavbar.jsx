...
const NAV_LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <rect x="2" y="4" width="12" height="9" stroke="currentColor" strokeWidth="1.4"/>
        <path d="M6 4V3h4v1" stroke="currentColor" strokeWidth="1.4"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <path d="M2 13c0-2 2-3 3-3s3 1 3 3" stroke="currentColor" strokeWidth="1.4"/>
        <path d="M8 13c0-2 2-3 3-3s3 1 3 3" stroke="currentColor" strokeWidth="1.4"/>
      </svg>
    ),
  },
  {
